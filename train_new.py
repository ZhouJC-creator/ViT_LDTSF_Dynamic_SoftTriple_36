...
def valid(args, model, writer, test_loader, epoch, global_step):
    ...
    return val_accuracy, select_num
...
def train(args, model):
    ...
    for epoch in range(args.num_epochs):
        ...
        with torch.no_grad():
            val_accuracy, select_num = valid(args, model, writer, test_loader, epoch, global_step)
        ...
        with open(result_file, 'a') as file:
            ...
            file.write('\n')
            file.write("select_num in epoch: %s" % str(select_num))
            file.write('\n')
